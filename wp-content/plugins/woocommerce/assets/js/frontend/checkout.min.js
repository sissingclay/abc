jQuery(function(a) {
    ...
    var b = {
            ...
            init_payment_methods: function(b) {
                var c = a(".woocommerce-checkout").find('input[name="payment_method"]');
                1 === c.length && c.eq(0).hide(), b && a("#" + b).prop("checked", !0), 0 === c.filter(":checked").length && c.eq(0).prop("checked", !0), c.filter(":checked").eq(0).trigger("click")
            },
            ...
            update_checkout_action: function(c) {
                jQuery('body').addClass('show_loader');
            ...
            submit: function() {
            	/**/
         /*   if($('#billing_first_name').val()=='' && $('#billing_last_name').val()=='' && $('#billing_last_name').val()=='' && $('#1_user_gender').val()=='Gender' && $('#2-user-nationality').val()=='Select your Nationality' && $('#3-user-dob').val()=='' && $('#4-user-passport-no').val()=='' && $('#billing_address_1').val()=='' && $('#billing_city').val()=='' && $('#billing_postcode').val()=='' && $('#billing_email').val()=='' && $('#billing_phone').val()=='' && $('#6-how-this-person-relates-to-you').val()=='Select your Next kin' && $('#7-emergency-firstname').val()=='' && $('#8-emergency-lastname').val()=='' && $('#9-emergency-address-line1').val()=='' && $('#9-emergency-city').val()=='' && $('#9-emergency-postcode').val()=='' && $('#9-emergency-email-address').val()=='' && $('#9-emergency-phoneno').val()=='' && $('#9-emergency-city').val()=='' && $('9-emergency-phoneno').val()=='') {
            	$('#billing_first_name_field').addClass('red');
            	$('#billing_last_name').addClass('red');
            	$('#1_user_gender').addClass('red');
            	$('#2-user-nationality').addClass('red');
            	$('#billing_last_name').addClass('red');
            	$('#billing_last_name').addClass('red');
            	$('#billing_last_name').addClass('red');
            	$('#billing_last_name').addClass('red');
            ...
            if($('#billing_first_name').val()==''){
            	...
            	$('#billing_first_name_field').removeClass('red');
            }*/
            //$('#place_order').click();
			 ...
			 jQuery.validator.addMethod("valueNotEquals1", function(value, element, arg){
              return (value != 'Gender');
			 // return arg != value;
			 }, "");
			 jQuery.validator.addMethod("valueNotEquals2", function(value, element, arg){
              return (value != 'Select your Nationality');
			 // return arg != value;
			 }, "");
			 jQuery.validator.addMethod("valueNotEquals3", function(value, element, arg){
              return (value != '');
			 // return arg != value;
			 }, "");
			 jQuery.validator.addMethod("valueNotEquals4", function(value, element, arg){
              return (value != 'Select your Next kin');
			 // return arg != value;
			 }, "");
			...
			jQuery('body').addClass('show_loader');
            var dataform = jQuery("#chk").validate({
					rules: {
						billing_last_name: {
							required: true,
                            maxlength: 100,
						...
						'1_user_gender': {
							required: true,
							valueNotEquals1:true,
							//nospace: true
						},'2-user-nationality': {
							required: true,
							valueNotEquals2:true,
							//nospace: true
						},'3-user-dob': {
							required: true,
							valueNotEquals3:true,
							DateFormat:true,
							//nospace: true
						},'4-user-passport-no': {
							required: true,
							...
							//valueNotEquals:true,
							//nospace: true
						},'6-how-this-person-relates-to-you': {
							required: true,
							valueNotEquals4:true,
							//nospace: true
						},
						'7-emergency-firstname': {
							required: true,
                            maxlength: 100,
							//valueNotEquals:true,
							//nospace: true
						},'8-emergency-lastname': {
							required: true,
                            maxlength: 100,
							//valueNotEquals:true,
							//nospace: true
						},'9-emergency-address-line1': {
							required: true,
                            maxlength: 300,
							//valueNotEquals:true,
							////nospace: true
							...
							//valueNotEquals:true,
							//nospace: true
						},'9-emergency-postcode': {
							required: true,
							number:true,
                            maxlength: 10,
							//valueNotEquals:true,
							//nospace: true
						},'9-emergency-email-address': {
							required: true,
							email:true,
							//valueNotEquals:true,
							//nospace: true
           ...
           // console.log(tool);
            ...
            submit_error: function(c) {
                $('body').removeClass('show_loader');
                a(".woocommerce-error, .woocommerce-message").remove(), b.$checkout_form.prepend(c), b.$checkout_form.removeClass("processing").unblock(), b.$checkout_form.find(".input-text, select, input:checkbox").blur(), a("html, body").animate({
                    scrollTop: a("form.checkout").offset().top - 100
