...
//				
            ...
            this.getFormData = function () {
                var data = {};
                if(results.comp.result >=50 && results.comp.result <= 80){
                    jQuery("#forms_1_5").val("Intermediate");
//                    alert("Intermediate");
                }
                else if(results.comp.result >= 90){
                    jQuery("#forms_1_5").val("Advanced");
//                    alert("Advanced");
                }
                else if(results.comp.result < 50){
                    jQuery("#forms_1_5").val("Beginner");
//                    alert("Beginner");
                }
                $e.find('.wpProQuiz_forms input, .wpProQuiz_forms textarea, .wpProQuiz_forms .wpProQuiz_formFields, .wpProQuiz_forms select').each(function () {
                    var $this = $(this);
