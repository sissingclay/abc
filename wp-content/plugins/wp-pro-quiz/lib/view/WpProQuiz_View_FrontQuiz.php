...
class WpProQuiz_View_FrontQuiz extends WpProQuiz_View_View
{
    ...
    private function loadButtonNames()
    {
        ...
        $names = array(
            ...
            'finish_quiz' => __('Finish test', 'wp-pro-quiz'),
            'send_me_my_results' => __('Send me my results', 'wp-pro-quiz'),
    ...
    private function showFormBox()
    {
		...
		<div class="thank-you">
			<p><strong>Thank you, your test has been submitted!</strong></p>
			<p>To receive your results, please fill in the form below.</p>
		</div>
                            ...
                            switch ($form->getType()) {
                                ...
                                case WpProQuiz_Model_Form::FORM_TYPE_NUMBER:
                                    echo '<input name="' . $name . '" id="' . $id . '" type="text" ',
                                        'data-required="' . (int)$form->isRequired() . '" data-type="' . $form->getType() . '" data-form_id="' . $form->getFormId() . '" placeholder= "' . $form->getFieldname() .'">';
                                    break;
    ...
    private function showInfoPageBox()
    {
        ...
        <div class="wpProQuiz_infopage" style="display: none;">
            ...
            <input type="button" name="endInfopage" class="btn_send_result" value="<?php echo $this->_buttonNames['send_me_my_results']; ?>"
                   class="wpProQuiz_button">
        </div>
        <?php
    }
