(function() {
    tinymce.PluginManager.add('scp_mce_shortcodes', function( editor, url ) {
        editor.addButton( 'scp_mce_shortcodes', {
            ...
            /**
             * Search Course Category Link
             */
                {
                    text: 'Search Course Category Link',
                    onclick: function() {
                        editor.windowManager.open( {
                            title: 'Insert Search Course Category Link Shortcode',
                            body: [
                                {
                                    ...
                                    label: 'Category Id',
                                    value: '',
                                    tooltip: 'Category IDs are printed next to the category name when you select to use categories. You can also go to Lessons/Course Categories, select a category and read the category id number from tag_ID form the url. Use number only.'
                                },
                                {
                                    type: 'textbox',
                                    name: 'title',
                                    label: 'Title',
                                    value: '',
                                    tooltip: 'Leave blank to use default category name.'
                                }
                            ],
                            onsubmit: function( e ) {

                                var shortcode = '[scp_search_category_link';

                                shortcode += ' category_id="' + e.data.category_id + '"';
                                shortcode += ' title="' + e.data.title + '"';
