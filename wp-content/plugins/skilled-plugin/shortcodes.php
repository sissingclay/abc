...
add_shortcode( 'scp_search_category_link', 'scp_search_category_link_shortcode' );
...
/**
 *  [scp_search_category_link category_id="1" title="Some Title"]
 */
function scp_search_category_link_shortcode( $atts ) {
	...
	if ( (int) $category_id ) {
		$out = '';
		$out .= '<a href="' . $category_id . '" id="' . $category_id . '">Title</a>';
	}
