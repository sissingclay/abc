...
function testimonial_rotator_excerpt( $limit = 25 )
{
	echo apply_filters('testimonial_rotator_the_excerpt', wp_trim_words(get_the_excerpt(), $limit ), $limit );
}
