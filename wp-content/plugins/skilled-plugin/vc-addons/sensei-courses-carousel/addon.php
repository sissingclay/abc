...
class Linp_VC_Sensei_Courses_Carousel {
	...
	function __construct() {
		...
		add_action( 'init', array( $this, 'integrateWithVC' ), 100 );
...
//			'parent' => 0,
		 ...
		 */
		vc_map( array(
			'name'        => __( 'Sensei - Courses Carousel', $this->textdomain ),
			...
			'params'      => array(
				...
				array(
					...
					'description' => __( 'If category is selected Course Type will be disregarded.', $this->textdomain ),
				),
				array(
					'type'       => 'dropdown',
					'holder'     => '',
	...
	public function render( $atts, $content = null ) {
		...
		if ( class_exists( 'WooThemes_Sensei' ) ) {
			...
			$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'linp-featured-courses-carousel ' . $el_class, $this->namespace, $atts );
...
new Linp_VC_Sensei_Courses_Carousel();
