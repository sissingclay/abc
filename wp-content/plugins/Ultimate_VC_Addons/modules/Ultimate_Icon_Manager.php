...
if(!class_exists('AIO_Icon_Manager'))
{
	class AIO_Icon_Manager
	{
		...
		?>
            ...
            <a href="#smile_upload_icon" class="add-new-h2 smile_upload_icon" data-target="iconfont_upload" data-title="<?php echo __("Upload/Select Fontello Font Zip","ultimate_vc") ?>" data-type="application/zip" data-button="<?php echo __("Insert Fonts Zip File","ultimate_vc"); ?>" data-trigger="smile_insert_zip" data-class="media-frame ">
