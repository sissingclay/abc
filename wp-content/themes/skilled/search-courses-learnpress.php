...
$search_args = array(
	'post_type'      => Skilled_LP_Keys::POST_TYPE,
...
$class_namespace = 'content-fullwidth';
?>
	...
	<div class="<?php echo skilled_class( 'container' ); ?>">
		<div class="<?php echo skilled_class( $class_namespace ); ?> course-container">
			...
			<div class="search-course-page-search-form-wrap">
				<?php echo get_template_part( 'templates/searchform-courses-small' ); ?>
			</div>
			<?php if ( $results->have_posts() ): ?>
				<?php include_once get_template_directory() . '/learnpress/custom/search-loop-items.php'; ?>
			<?php else: ?>
