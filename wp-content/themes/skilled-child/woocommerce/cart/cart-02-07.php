...
//        var coursestartdate = jQuery( "#coursestartdate option:selected" ).text();   
        ...
        success: function( result ) {
            ...
            setTimeout(function () {
                if (jQuery('#acc_enddate').data('max') && jQuery('#acc_startdate').data('min')) {
...
//        autoclose:true
   ...
   var updateCart
    ...
    jQuery( document ).ready( function(jQuery) {    
        $.when( $.ajax('http://swapi.co/api/people/1/'), $.ajax('http://swapi.co/api/starships/9/') )
        .done(function ( v1, v2 ) {
            console.log( v1 ); // "Fish"
            ...
            success:function(result){   
                ...
                jQuery.ajax({
                        ...
                        success: function( result1 ) {
                            ...
                            setTimeout(function(){
                                $('body').addClass('show_loader'); 
                                jQuery.get(site_url+'/wp-admin/admin-ajax.php?post_type=product&add-to-cart=' + p_id +'&variation_id='+result +'&attribute_pa_course_level='+course_level+'&attribute_pa_week='+courseweek+'&attribute_pa_course_startdate='+coursestartdate,
                                function() {
