        ...
        if($product_category->slug == '1course') { ?>
            ...
            <div class="radio-ctype" style="display:block;padding:0 0 10px;">
                ...
                while ( $products->have_posts() ) { $products->the_post(); $icnt++; ?>
                    <span class="prod-radio" id="prod-<?php echo $icnt; ?>" style="display:none;padding-right:10px;"><input type="radio" name="productname" class="productname" value="<?php the_id(); ?>" data-title="<?php echo get_the_title(get_the_ID()); ?>"> <?php echo $wc_cpdf->get_value(get_the_ID(), 'product_radio_title'); ?></span>
                <?php } ?>
            </div>
...
<script src="<?php echo $site_url;?>/wp-content/themes/skilled-child/js/cart.js"></script>
