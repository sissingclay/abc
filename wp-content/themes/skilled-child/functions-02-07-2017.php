         ...
         /*  print_r($proc_price);
           die('fdg');*/
            if($_POST['back_productid'] == "19531") {
                            $valuenew ='Callan Light &ndash; 5 lessons (Callan light)';
                          /*  echo $valuenew."fdd";
                            die('sfd');*/
                        } else if($_POST['back_productid']=='19482'){
                             $valuenew ='Callan Light &ndash; 10 lessons (Callan essential)';
                        } else if($_POST['back_productid']=='19433'){
                             $valuenew ='Callan Light &ndash; 15 lessons (Callan intensive)';
                        } else if($_POST['back_productid']=='19384'){
                             $valuenew ='Callan Light &ndash; 20 lessons (Callan super intensive)';
                        } else{
                            $valuenew = $vt[1];
                        }
...
add_action( 'wp_ajax_cart_data_info', 'cart_data_info' );
add_action( 'wp_ajax_nopriv_cart_data_info', 'cart_data_info' );

function cart_data_info() {
    session_start();
...
function getaccweek(){
    ...
    //    ini_set("display_errors","1");
         ...
         for($i=1;$i<=$week;$i++){
            ...
            echo "<input type='text' name='acc_startdate' id='acc_startdate' placeholder='Starting date' value=".$newdate." data-min=".$nxtdate." readonly>";
            echo "</div>";
