function hideOthers(){
    ...
    function updateDisplayLabel () {
        var label = $("input[name='productname']:checked").val();

        switch (label) {
            case '19531':
                return ' 5 lessons (Callan light)';
            case '19482':
                return ' 10 lessons (Callan essential)';
            case '19433':
                return ' 15 lessons (Callan intensive)';
            case '19384':
                return ' 20 lessons (Callan super intensive)';
            default: 
                return $("input[name='productname']:checked").parent('span').text();
        }
    }

    function courseTitle () {
        var courseTitle = $('#getProductOption option:selected').html();
        var valuenew = $("input[name='productname']:checked").val();
        var intensiveTitle = 'Intensive English';

        switch (valuenew) {
            case '19286':
                return intensiveTitle;
            case '19237':
                return intensiveTitle;
            case '19127':
                return intensiveTitle;
    ...
    function updateRadioBtnDisplay (ids, reset) {
    ...
    function getProductOption(){ 
        ...
        var prodDisplayName = jQuery( ".product-name" );
        if (prodDisplayName.length) prodDisplayName.html(jQuery( "#getProductOption option:selected" ).text())
        $('.hide_show').hide();
        $('.oned').hide();
        $('.one20').hide();
        $('.one1').hide();
        ...
        if(prod_id == 0){
            updateRadioBtnDisplay('', true);
        }
        if(prod_id == 1){
            updateRadioBtnDisplay('#prod-5, #prod-2, #prod-3, #prod-4');
        }
        if(prod_id == 2){
            updateRadioBtnDisplay('#prod-6, #prod-9, #prod-7, #prod-8');
        }
        if(prod_id == 3){
            updateRadioBtnDisplay('#prod-9, #prod-7, #prod-8');
        }
        if(prod_id == 4){
            updateRadioBtnDisplay('#prod-12, #prod-10, #prod-11');
        }
        if(prod_id == 5){
            updateRadioBtnDisplay('#prod-1,#prod-13');
        }
...
ex:is_set_charge,
    ...
    function setVisa () {
        if (jQuery( "#courseweek :selected" )) {
            if (typeof jQuery( "#courseweek :selected" ).text() !== 'undefined') {
                var findNumber = jQuery( "#courseweek :selected" ).text().split(' ');
                var selectOption = jQuery('#visa_require option[value=' + 19870 + ']');
                var number = parseInt(findNumber[0], 10);
                if (typeof number === 'number' && number > 24) {
                    selectOption.hide();
                } else {
                    selectOption.show();
                }
    ...
    function getcourselevel(s){
        ...
        jQuery.ajax({
            ...
            success: function( result ) {
                ...
                if (abc.click_back) {
                    if(abc.course && abc.course.back_course_level && abc.course.back_course_level) {
                        jQuery("#course_level option[value=" + abc.course.back_course_level + "]").attr('selected','selected');
                    ...
                    success: function( result1 ) {
                       ...
                       // if(acczone!=undefined) {
                        setTimeout(function(){
                             var acczone = jQuery( "#acc_zone input[name=productacczone]:checked" ).val(); 
                           //  alert(acczone);
                        jQuery.get(site_url+'/wp-admin/admin-ajax.php?post_type=product&add-to-cart=' + cat_id +'&variation_id='+result +'&quantity='+week_nos+'&attribute_pa_zone='+acczone,
                        function() {});
                        },500);
                        //}
                        jQuery.ajax({
...
ex:is_set_charge,
                                        ...
                                        success: function( result ) {
                                            ...
                                            if (abc.click_back) {
                                                if (abc.accommodation && abc.accommodation.back_acc_supplement) {
                                                    jQuery("#acc_supplement option[value=" + abc.accommodation.back_acc_supplement + "]").attr('selected','selected').change();                                                
                                                }
                                                if (abc.accommodation && abc.accommodation.back_smoke) {
                                                    jQuery("#smoke option[value=" + abc.accommodation.back_smoke + "]").attr('selected','selected');
                                                }
                                                if (abc.accommodation && abc.accommodation.back_petbother) {
                                                    jQuery("#petbother option[value=" + abc.accommodation.back_petbother + "]").attr('selected','selected');                                                
                                                }
                                                if (abc.accommodation && abc.accommodation.back_allergies) {
                                                    jQuery("#allergies").attr('checked', true);                                          
                                                }
                                                if (abc.accommodation && abc.accommodation.back_allergiestype) {
                                                    jQuery("#allergiestype").val(abc.accommodation.back_allergiestype);                                                
                                                }
                                                if (abc.accommodation && abc.accommodation.back_bathroom) {
                                                    jQuery("#bathroom").val(abc.accommodation.back_bathroom);
                                                    if(i == 0) {
                                                        jQuery("#bathroom").change();
                                                    }
                                                    i++;
                                                }
                                                if (abc.accommodation && abc.accommodation.back_transport_type) {
                                                    jQuery("#transport_type option[value=" + abc.accommodation.back_transport_type + "]").attr('selected','selected');
                                                    setTimeout(function () {
                                                        jQuery("#transport_type").trigger('change');                                                
                                                    }, 800);
                                                } 
                                                
                                                if(abc.accommodation && abc.accommodation.back_visa_require) {
                                                    jQuery("#visa_require option[value=" + abc.accommodation.back_visa_require + "]").attr('selected','selected');
                                                    setTimeout(function () {
...
//                    }});
    ...
    function getWeekData(hideLoader){
        if(!hideLoader)$('body').addClass('show_loader');
...
//        var coursestartdate = jQuery( "#coursestartdate option:selected" ).text();   
        ...
        success: function( result ) {
            ...
            if(!hideLoader)$('body').removeClass('show_loader');
            var str = $('#courseweek option:selected').html();
            str = str.toLowerCase().replace(/\b[a-z]/g, function(letter) {
                return letter.toUpperCase();
            });
            jQuery("#accomodation_cart").html('<div id="accomodation_cart"><table><tbody><tr><td colspan="2"><div class="maincart"><div class="proc_name marbottom20 mob-padtb20"><b style="color:#32a3aa;font-size:18px;font-weight:400;">Shopping cart</b></div></div></td></tr><tr><td colspan="2"><div class="maincart"><div class="proc_name"><b class="product-name">'+ courseTitle() +' &ndash;'+ updateDisplayLabel() +'</b></div></div></td></tr><tr><td><ul class="check-list"><li><div class="acc-supply">Course length: '+  str +'<br>Course start date: '+ $('#course_date').val() +'</div></li></ul></td></tr> <tr  class="accu_r"><td colspan="2"><div class="maincart"><div class="proc_name"><b>Accommodation</b></td></tr><tr class="accu_r2"><td><ul class="check-list"><li><div class="acc-supply">No accommodation required</div></li></ul></td></tr><tr  class="accu_m"><td colspan="2"><div class="maincart"><div class="proc_name"><b>Visa</b></td></tr><tr  class="accu_m2"><td><ul class="check-list"><li><div class="acc-supply">No visa required</div></li></ul></td></tr><tr><td><br></td></tr></tbody></table></div>');  
           
            setTimeout(function () {
                var maxDate = jQuery('#acc_enddate').data('max').split('/');
                var minDate = jQuery('#acc_startdate').data('min').split('/');
...
//                          console.log("Inside false Current Date"+dmy);
    ...
    function setWeeks(){
        ...
        jQuery.ajax({
            ...
            success: function( result ) {
                ...
                if (abc.click_back) {
                    if(abc.course && abc.course.back_courseweek && abc.course.back_courseweek) {
                        jQuery("#courseweek option[value=" + abc.course.back_courseweek + "]").attr('selected','selected');
   ...
   var updateCart
    ...
    jQuery( document ).ready( function(jQuery) {
       ...
       updateCart = function courseUpdate() {
          $('.oned').hide();
          $('.one20').hide();
            $('.one1').hide();
            $('.one2').hide();
...
//            var coursestartdate = jQuery( "#coursestartdate option:selected" ).text();
            ...
            jQuery.ajax({
                ...
                success:function (result) {
                    ...
                    .then(function () {
                        return jQuery.ajax({
                            type: 'GET',
                            url: site_url + '/wp-admin/admin-ajax.php?post_type=product&add-to-cart=' + p_id +'&variation_id=' + result + '&attribute_pa_course_level=' + course_level + '&attribute_pa_week=' + courseweek + '&attribute_pa_course_startdate=' + coursestartdate
                        }) // second ajax call
                    })
                    .then(function () {
                        var back_product_id = jQuery( ".prod-radio input[name=productname]:checked" ).val();
                    ...
                    .done(function (res1, res2) {
                        ...
                        if(abc && abc.fee_charge) {
                            jQuery("#ex-student option[value=" + abc.fee_charge + "]").attr('selected','selected');                    
                        }

                        if ($('#course_level').val() == 'I think my level is') {
                            str = $('#courseweek option:selected').html();
                            str = str.toLowerCase().replace(/\b[a-z]/g, function(letter) {
                                return letter.toUpperCase();
                            });
                            jQuery("#accomodation_cart").html(res2); 
                        }  else {
                            if(res2 == '<table>'){
                                changeWeek();
                            } else {
                        ...
                        if (abc.click_back) {
                            if (abc.accommodation && abc.accommodation.back_accomdation) {
                                jQuery("#accomdation option[value=" + abc.accommodation.back_accomdation + "]").attr('selected','selected'); 
                                jQuery("#accomdation").val(abc.accommodation.back_accomdation).trigger('change');                   
                                allowShowAccOption();                                                
                            }
                        }

                        if (abc.click_back) {
                            if (abc.accommodation && abc.accommodation.back_meal_plan) {
                                jQuery("#prod-acc-meal-plan option[value=" + abc.accommodation.back_meal_plan + "]").attr('selected','selected');
                                jQuery("#prod-acc-meal-plan").trigger('change');
                            }
                        }
                        ...
                        if($('#allow_hide').is(":visible") == false) {
                            ...
                            setTimeout(function () {
                                ...
                                if (abc.click_back) {
                                    if(abc.accommodation && abc.accommodation.back_smoke) {
                                        $('#smoke').val(abc.accommodation.back_smoke).change();
                                    }
                                }
                                
                                if (abc.click_back) {
                                    if(abc.accommodation && abc.accommodation.back_petbother) {
                                        $('#petbother').val(abc.accommodation.back_petbother).change();
                                    }
                                }
                            }, 0);
                        }
        ...
        jQuery(document).on( 'change', '#courseweek', updateCart);
        jQuery(document).on( 'change', '#course_level', updateCart);
...
//                    url: site_url+'/wp-admin/admin-ajax.php?action=remove_cart_data',
                    ...
                    success: function( result1 ) {
                        ...
                        setTimeout(function(){
                             var acczone = jQuery( "#acc_zone input[name=productacczone]:checked" ).val();
                                jQuery.get(site_url+'/wp-admin/admin-ajax.php?post_type=product&add-to-cart=' + cat_id +'&variation_id='+result +'&quantity='+coursesweek_number+'&attribute_pa_zone='+acczone,
                                function() {});
                                },500);
                                ...
                                setTimeout(function(){
                                        ...
                                        jQuery.ajax({
                                                ...
                                                success: function( result ) {
                                                    ...
                                                    if (abc.click_back) {
                                                        if(abc.accommodation && abc.accommodation.back_flightname) {
                                                            jQuery("#flightname").val(abc.accommodation.back_flightname);                                                        
                                                        }
                                                        if(abc.accommodation && abc.accommodation.back_arrivaldate) {
                                                            jQuery("#arrivaldate").val(abc.accommodation.back_arrivaldate);                                                        
                                                        }
                                                        if(abc.accommodation && abc.accommodation.back_departuredate) {
                                                            jQuery("#departuredate").val(abc.accommodation.back_departuredate);                                                        
                                                        }
                                                        if(abc.accommodation && abc.accommodation.back_visa_require) {
                                                            jQuery("#visa_require option[value=" + abc.accommodation.back_visa_require + "]").attr('selected','selected');
                                                            jQuery("#visa_require").trigger('change');
...
<script>
    if (abc.click_back) {
        if(abc.course && abc.course.back_productid == '') {
            abc.course.back_productid =  abc.course.back_productidpop;
        }
        if(abc.course && abc.course.back_productid && abc.course.back_productid != '') {
            jQuery("input:radio[value^=" + abc.course.back_productid + "]").prop("checked", true).trigger("click");
            getProductOption();
        }
    }
