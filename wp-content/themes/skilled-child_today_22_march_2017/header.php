	...
	<div class="cbp-row wh-top-bar">
		<div class="cbp-container">
			<div class="one whole wh-padding wh-top-bar-text align-right">
				...
				<img src="http://wordpress-9522-31986-161247.cloudwaysapps.com/wp-content/uploads/2016/11/business_Logo.png" alt="logo" />
				</a></div>
				</div>
				<div class="three fourths wh-padding wh-top-bar-additional-text align-left">
                  <span class="scp-icon scp-icon-background pull-right" style="margin: 0 0px 0 8px;text-align:center;">
                     <form class="search-form form-inline" action="http://wordpress-9522-31986-161247.cloudwaysapps.com/" method="get"><input class="search-field" name="s" value="" placeholder="Search " type="search">
                        <img class="search-icon" src="http://wordpress-9522-31986-161247.cloudwaysapps.com/wp-content/uploads/2016/12/search-top.png">
                  ...
                  <div class="scp-shortcode scp-icon-bullet-text pull-right lang-margin" style="padding: 0px;">
                     <div class="align-center scp-icon-bullet-text-icon" style="color: #666; font-size: 32px;"><img src="http://wordpress-9522-31986-161247.cloudwaysapps.com/wp-content/uploads/2016/12/earth.png"></div>
...
?>
                  ...
                  <div class="scp-shortcode scp-icon-bullet-text pull-right phone-margin" style="padding: 0px;">
                     <div class="align-center scp-icon-bullet-text-icon" style="color: #666; font-size: 32px;"><img src="http://wordpress-9522-31986-161247.cloudwaysapps.com/wp-content/uploads/2016/12/phone.jpg"></div>
