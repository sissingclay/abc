...
//            echo "</div>"; 
             ...
             echo "<select name='smoke' id='smoke' disabled=''><option value=''>Do you smoke?</option>
                            ...
                            <option value='nosmpoke'>No, I don't smoke</option>
                    </select>";
            
            echo "<select name='petbother' id='petbother' disabled=''><option value=''>Do bets bother you?</option>
                            <option value='nopetbother'>Yes, they bother me</option>
                            <option value='yespetbother'>No, they don't bother me</option>
                    </select>";
