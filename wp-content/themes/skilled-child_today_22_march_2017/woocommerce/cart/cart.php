    ...
    foreach ( $product_categories as $product_category ) {
        ...
        if($product_category->slug == '1course') { ?>
            <select id="getProductOption" onchange='getProductOption()'>
                ...
                <option value='5' <?php if($_SESSION['course']['back_getProductOption'] == 5) { ?>selected<?php } ?>>Exam Course</option>
            </select>
                                ...
                                jQuery.ajax({
                                        ...
                                        success: function( result ) {
                                            ...
                                            if(!empty($_SESSION['accomodation']['back_acc_supplement']) && $_SESSION['accomodation']['back_acc_supplement'] != ''){ ?>
                                                jQuery("#acc_supplement option[value=<?php echo $_SESSION['accomodation']['back_acc_supplement']; ?>]").attr('selected','selected');                                                
                                            <?php } } ?>
                                            <?php if(!empty($_SESSION['is_back']) && $_SESSION['is_back'] == 'back_click'){
