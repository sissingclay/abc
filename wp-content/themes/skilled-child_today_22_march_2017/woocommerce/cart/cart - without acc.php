...
//          echo "</div>";
            ...
            echo "<select disabled><option>Course Level</option></select>";
            echo "</div>";
        ...
        if($product_category->slug == '2accomdation') { ?>
            <?php /*<select id='accomdation' name="accomdation" onchange='allowShowAccOption()' disabled>
            ...
            echo "<select id='accomdation' onchange='allowShowOthers()' disabled><option value='' selected='selected'>No Accomdation Thanks</option>";
            ...
            echo "<div id='div_acczones' style='display:none'>";
			...
			echo "</div>";
            echo "<div >";
            echo "<select id='accomodation_week' disabled='' style='width:49%'><option>Accommodation Length</option></select>";
            echo "</div>";
...
//            echo "</div>"; 
             ...
             echo "<select name='smoke' id='smoke' disabled=''><option value=''>I Smoke</option>
                            <option value='yessmpoke'>Yes,I Smoke</option>
                            <option value='nosmpoke'>No,I dont Smoke</option>
                    </select>";
            
            echo "<select name='petbother' id='petbother' disabled=''><option value=''>Pets bother me</option>
                            <option value='nopetbother'>I don't mind pets </option>
                            <option value='yespetbother'>I mind pets </option>
                    </select>";
        ...
        if($product_category->slug == '3extras') {  
            echo "<select id='transport_type' disabled=''><option value='' selected>Airport Transport</option>";
            ...
            echo '<input type="text" name="flightname" id="flightname" disabled placeholder="Airline Name and Flight Number"><br>';
            
            echo '<input type="text" name="arrivaldate" id="arrivaldate" disabled placeholder="Arrival Date & Time" >';
...
//                </div>";
            ...
            echo '<input type="text" name="departuredate" id="departuredate" disabled placeholder="Departure Date & Time"><br>';
            echo "</div>";
...
//			echo '<h4 ><div class="extra-second-section">' . $product_category->name . '</div></h4>';
             echo "<select name='visa_require' id='visa_require' '><option value='' selected>Do you need a visa to study in UK?</option>";
            while ( $products->have_posts() ) {
                $products->the_post();
                ?>
                    <option value="<?php the_id(); ?>">
...
//        jQuery("#acc_zone").html("");
    ...
    jQuery('.cart-step1').on("click",".prod-radio-acco input:radio",function() {
        if(jQuery(".prod-radio-acco input[name=productname]:checked").val()){
            showOthers();
        }
        else hideOthers();
    });
...
//              jQuery("#coursestartdate").html(result);
    ...
    function changeWeek(){
        ...
        var acczone = jQuery( "#acc_zone option:selected" ).val();
...
//        change cart data after selecting datepicker
         var cat_id = jQuery( "#accomdation option:selected" ).val(); 
         var extracharges = jQuery( "#extrafees" ).val();
...
//                                                        'coursesweek_number': coursesweek_number,
        ...
        jQuery(document).on( 'change', '#accomdation', get_acczones);
        
        function get_acczones(){ 
            var product_id = jQuery("#accomdation").val();
            jQuery.ajax({
                type: 'post',
		...
		jQuery(document).on( 'change', '#accomdation', accomChange);
		jQuery(document).on( 'change', '#acc_zone', accomChange);
